    ...
    def fit(
        ...
        for epoch in tqdm(range(epochs)):
            ...
            if epoch % test_interval == 0 and epoch > 1:
                ...
                val_metrics = compute_deferral_metrics(data_test, sens=False)
        ...
        return compute_deferral_metrics(self.test(dataloader_test), sens=False)
    ...
    def test(self, dataloader):
        ...
        with torch.no_grad():
            for batch, (data_x, data_y, hum_preds, _) in enumerate(dataloader):
                ...
                sensitive_all.extend([0] * len(data_y))
        # convert to numpy
