...
class BrowardDataset(BaseDataset):
    ...
    def generate_data(self):
        ...
        # divide broward data into val, test, and train
        # print("broward_data: ", broward_data)
        train_x = broward_data.to_numpy()
        self.sensitive_features = train_x[:, 0]
        # normalize data
        ...
        self.sensitive_features = torch.tensor(self.sensitive_features).long()
        ...
        self.train_s, self.val_s, self.test_s = torch.utils.data.random_split(
        ...
        self.data_train = torch.utils.data.TensorDataset(
            ...
            self.train_s.dataset.data[self.train_s.indices],
        )
        self.data_val = torch.utils.data.TensorDataset(
            ...
            self.val_s.dataset.data[self.val_s.indices],
        )
        self.data_test = torch.utils.data.TensorDataset(
            ...
            self.test_s.dataset.data[self.test_s.indices],
        )
